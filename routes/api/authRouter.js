...
const { validation, register, login, subscription, avatar } = require("../../src/middlewares/validationMiddleware");
...
router.patch("/avatars", authMiddleware, validation(avatar), uploadMiddleware.single('avatar'), asyncWrapper(ctrlAuth.updateAvatar));
